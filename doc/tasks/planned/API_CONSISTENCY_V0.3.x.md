...
- [ ] Task 1.3: Document color parameter naming conventions in user docs
- [ ] Task 4.1-4.2: Update docstrings and examples for alignment semantics
- [ ] Task 5.3: Document error handling principles
- [ ] Task 6.3: Update emoji guide with examples reference

### Phase 3: Optional API Extensions (v0.3.x - Optional)

- [ ] Task 1.1: Extend `Console.frame()` to support `start_color`/`end_color` gradients
- [ ] Add gradient frame tests
- [ ] Add gradient frame examples
