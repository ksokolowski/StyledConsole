...
2. **Empty Title Handling** - Consistent behavior for `None` and `""` parameters
3. **Emoji Rendering** - Accurate alignment for VS16-containing emojis
...
2. Would allow explicit different characters without conditionals
3. Could be added in future version without breaking changes
