...
def main():
    ...
    lines = renderer.render_with_border_gradient(
        ...
        border="rounded",
        border_start_color="red",
        border_end_color="blue",
        width=40,
    )
    for line in lines:
        print(line)
    ...
    lines = renderer.render_with_border_gradient(
        ...
        border_start_color="red",
        border_end_color="blue",
        content_start_color="yellow",
        content_end_color="magenta",
        width=45,
    )
    for line in lines:
        print(line)
    ...
    lines = renderer.render_with_border_gradient(
        ...
        title="🔥 FIRE FRAME 🔥",
        border="heavy",
        border_start_color="yellow",
        border_end_color="red",
        width=35,
    )
    for line in lines:
        print(line)
    ...
    lines = renderer.render_with_border_gradient(
        ...
        title="🌊 Ocean Frame",
        border="rounded",
        border_start_color="cyan",
        border_end_color="darkblue",
        content_start_color="lightblue",
        content_end_color="blue",
        width=35,
    )
    for line in lines:
        print(line)
