    ...
    def frame(
        ...
        *,
        ...
        Args:
            ...
            start_color: Content gradient start color
            end_color: Content gradient end color
            border_gradient_start: Border gradient start color
            border_gradient_end: Border gradient end color
    ...
    def banner(
        ...
        *,
        ...
        Args:
            ...
            width: Fixed width or None
            align: Alignment ('left', 'center', 'right')
            padding: Padding around banner
        """
    ...
    def rule(
        ...
        *,
        ...
        Args:
            ...
            color: Rule color
            style: Line style (currently only 'solid')
...
console.banner("DEPLOY", start_color="gold", end_color="orange")
console.banner("OCEAN", start_color="lightblue", end_color="navy")
```
