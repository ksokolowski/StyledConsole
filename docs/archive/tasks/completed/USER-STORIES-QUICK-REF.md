...
1. Create "Gallery" page with rendered screenshots
1. Extract 5-10 code patterns as recipes
1. Build interactive examples for docs site

### Testing

1. Generate unit tests from all 26 success criteria
1. Create emoji alignment test suite (50+ emojis)
1. Test all CSS4 colors mentioned (15+ colors)
1. Verify all border style + color combinations

### Implementation

1. Start with Core API (Console.frame, Console.banner)
1. Implement all 5 border styles
1. Add CSS4 color name support (148 colors)
1. Test emoji width handling (wcwidth integration)
1. Build HTML export matching terminal output
